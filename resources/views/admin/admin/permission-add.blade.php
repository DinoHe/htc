...
@section('tittle')权限添加 @endsection

@section('container')
    <article class="cl pd-20">
        <form action="{{url('admin/adminPermissionAdd')}}" method="post" class="form form-horizontal" id="form-admin-permission-add">
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="url" required>
                </div>
            </div>
            <div class="row cl">
