...
@section('tittle')等级编辑 @endsection
	...
	<form action="{{url('admin/memberLevelEdit')}}" method="post" class="form form-horizontal">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="会员等级" name="levelName" value="{{$level->level_name}}" required>
			</div>
		</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>每天卖币次数：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="number" class="input-text" name="salesTimes" value="{{$level->sales_times}}" min="0" required>
            </div>
        </div>
		<div class="row cl">
